...
def plot_currents(t):
    ...
    ja_yi.data = get_parsed_field(ja_yi, "E", "Y", "y", t)
    ja_ye.data = get_parsed_field(ja_ye, "E", "Y", "y", t)
...
if __name__ == "__main__":
    ...
    ja_yi = particles_field("Ions", "Current", "Y", subplot(fig, gs, 1, 0), "$J_{\\phi}^i$", (-v, +v))
    ja_zi = particles_field("Ions", "Current", "Z", subplot(fig, gs, 2, 0), "$J_{\\phi}^i$", (-v, +v))

    ja_xe = particles_field("Electrons", "Current", "X", subplot(fig, gs, 0, 1), "$J_{\\phi}^e$", (-v, +v))
    ja_ye = particles_field("Electrons", "Current", "Y", subplot(fig, gs, 1, 1), "$J_{\\phi}^e$", (-v, +v))
    ja_ze = particles_field("Electrons", "Current", "Z", subplot(fig, gs, 2, 1), "$J_{\\phi}^e$", (-v, +v))
